...
:= λ S dS,  
   match dS with 
   | Certify_Commutative _            => Certify_Commutative (with_constant S) 
   | Certify_Not_Commutative _ (s, t) => 
...
:= λ S dS,  
   match dS with 
   | Certify_Selective _          => Certify_Selective(with_constant S) 
   | Certify_Not_Selective _ (s, t) => 
...
:= λ S dS,  
   match dS with 
   | Certify_Idempotent _     => Certify_Idempotent (with_constant S) 
   | Certify_Not_Idempotent _ s => Certify_Not_Idempotent (with_constant S) (inr _ s) 
   end. 
...
:= λ S dS,  
   match dS with 
   | Certify_Exists_Id _ i   => Certify_Exists_Id (with_constant S) (inr _ i)
   | Certify_Not_Exists_Id _ => Certify_Not_Exists_Id (with_constant S) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Certify_Not_Is_Left (with_constant S) (inr _ s, inl _ c) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Assert_Not_Is_Left (with_constant S) (inr _ s, inl _ c) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Certify_Not_Is_Right (with_constant S) (inl _ c, inr _ s) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Assert_Not_Is_Right (with_constant S) (inl _ c, inr _ s) 
   end. 
...
:= λ S dS,  
   match dS with 
   | Certify_Exists_Ann _ a    => Certify_Exists_Ann (with_constant S) (inr _ a)
   | Certify_Not_Exists_Ann _ => Certify_Not_Exists_Ann (with_constant S) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Certify_Not_Is_Left (with_constant S) (inl _ c, inr _ s)
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Assert_Not_Is_Left (with_constant S) (inl _ c, inr _ s)
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Certify_Not_Is_Right (with_constant S) (inr _ s, inl _ c) 
   end. 
...
:= λ S c dS,  
   match dS with 
   | Certify_Witness _ s => Assert_Not_Is_Right (with_constant S) (inr _ s, inl _ c) 
   end. 
...
:= λ S c ad lcd,  
   ...
   | Certify_Anti_Left _ => 
        match lcd with 
        | Certify_Left_Cancellative _     => Certify_Left_Cancellative (with_constant S) 
        | Certify_Not_Left_Cancellative _ (s1, (s2, s3)) => 
             Certify_Not_Left_Cancellative (with_constant S) (inr s1, (inr s2, inr s3))
        end 
   | Certify_Not_Anti_Left _ (s1, s2) => 
...
:= λ S c ad lcd,  
   match ad with 
   | Certify_Anti_Right _ => 
        match lcd with 
        | Certify_Right_Cancellative  _     => Certify_Right_Cancellative (with_constant S) 
        | Certify_Not_Right_Cancellative _ (s1, (s2, s3)) => 
             Certify_Not_Right_Cancellative (with_constant S) (inr s1, (inr s2, inr s3)) 
        end 
   | Certify_Not_Anti_Right _ (s1, s2) => 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Commutative _, Certify_Commutative _ => Certify_Commutative _ 
      | Certify_Not_Commutative _ (s1, s2), _       => Certify_Not_Commutative _ ((s1, t), (s2, t))
      | _, Certify_Not_Commutative _ (t1, t2)       => Certify_Not_Commutative _ ((s, t1), (s, t2))
      end 
   end. 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Left_Cancellative _, Certify_Left_Cancellative _ => Certify_Left_Cancellative _
      | Certify_Not_Left_Cancellative _ (s1, (s2, s3)), _ => 
           Certify_Not_Left_Cancellative _ ((s1, t), ((s2, t), (s3, t)))
      | _, Certify_Not_Left_Cancellative _ (t1, (t2, t3))  => 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Right_Cancellative _ , Certify_Right_Cancellative _ => Certify_Right_Cancellative _
      | Certify_Not_Right_Cancellative _ (s1, (s2, s3)), _ => 
           Certify_Not_Right_Cancellative _ ((s1, t), ((s2, t), (s3, t)))
      | _, Certify_Not_Right_Cancellative _ (t1, (t2, t3))  => 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Left_Constant _, Certify_Left_Constant _ => Certify_Left_Constant _
      | Certify_Not_Left_Constant _ (s1, (s2, s3)), _ => 
           Certify_Not_Left_Constant _ ((s1, t), ((s2, t), (s3, t)))
      | _, Certify_Not_Left_Constant _ (t1, (t2, t3))  => 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Right_Constant _, Certify_Right_Constant _ => Certify_Right_Constant _
      | Certify_Not_Right_Constant _ (s1, (s2, s3)), _ => 
           Certify_Not_Right_Constant _ ((s1, t), ((s2, t), (s3, t)))
      | _, Certify_Not_Right_Constant _ (t1, (t2, t3))  => 
...
:= λ S T dS dT,  
   match dS with 
   | Certify_Anti_Left _ => Certify_Anti_Left _ 
   | Certify_Not_Anti_Left _ (s1, s2)  => 
     match dT with 
     | Certify_Anti_Left _ => Certify_Anti_Left _ 
     | Certify_Not_Anti_Left _ (t1, t2)  => Certify_Not_Anti_Left _ ((s1, t1), (s2, t2))
     end 
   end. 
...
:= λ S T dS dT,  
   match dS with 
   | Certify_Anti_Right _ => Certify_Anti_Right _ 
   | Certify_Not_Anti_Right _ (s1, s2)  => 
     match dT with 
     | Certify_Anti_Right _ => Certify_Anti_Right _ 
     | Certify_Not_Anti_Right _ (t1, t2)  => Certify_Not_Anti_Right _ ((s1, t1), (s2, t2))
     end 
   end. 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Idempotent _, Certify_Idempotent _ => Certify_Idempotent _ 
      | Certify_Not_Idempotent _ s1 , _       => Certify_Not_Idempotent _ (s1, t) 
      | _, Certify_Not_Idempotent _ t1        => Certify_Not_Idempotent _ (s, t1) 
      end
   end.
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Is_Left _, Certify_Is_Left _ => Certify_Is_Left _ 
      | Certify_Not_Is_Left _ (s1, s2), _  => Certify_Not_Is_Left _ ((s1, t), (s2, t))
      | _, Certify_Not_Is_Left _ (t1, t2)  => Certify_Not_Is_Left _ ((s, t1), (s, t2))
      end 
   end. 
...
:= λ S T ntT nlS,  
   ...
   | Certify_Witness _ t, Assert_Not_Is_Left _ (s1, s2) => Assert_Not_Is_Left _ ((s1, t), (s2, t))
   end. 
...
:= λ S T ntS ntT cS cT,  
   ...
   | Certify_Witness _ s, Certify_Witness _ t => 
      match cS, cT with 
      | Certify_Is_Right _, Certify_Is_Right _ => Certify_Is_Right _ 
      | Certify_Not_Is_Right _ (s1, s2), _   => Certify_Not_Is_Right _ ((s1, t), (s2, t))
      | _, Certify_Not_Is_Right _ (t1, t2)   => Certify_Not_Is_Right _ ((s, t1), (s, t2))
      end
   end. 
...
:= λ S T ntS nrT,  
   ...
   | Certify_Witness _ s, Assert_Not_Is_Right _ (t1, t2) => Assert_Not_Is_Right _ ((s, t1), (s, t2))
   end.
...
:= λ S T nlS nrT,  
     match nlS, nrT with 
     | Assert_Not_Is_Left _ (s1, s2), Assert_Not_Is_Right _ (t1, t2) => 
     ...
     | Certify_Not_Is_Left _ (s1, s2) => 
       ...
       | Certify_Is_Right _ =>  
         (* RIGHT S *) 
           ...
           | Certify_Not_Is_Right _ (t1, t2) => 
             (* NOT RIGHT T *) Certify_Not_Selective _ ((s1, t1), (s2, t2)) 
           end 
       | Certify_Not_Is_Right _ (s3, s4) =>  
          (* NOT RIGHT S *)   (* extra case *) 
           match crT with 
           | Certify_Is_Right _ => 
             (* RIGHT T *) (* MUST BE NOT LEFT T *) 
              match clT with 
              | Certify_Is_Left _ => (* NOT POSSIBLE *) Certify_Selective _ 
              | Certify_Not_Is_Left _ (t1, t2) => Certify_Not_Selective _ ((s3, t1), (s4, t2))
              end 
           | Certify_Not_Is_Right _ (t1, t2) => 
             (* NOT RIGHT T *)  
             match clT with  (* why needed ??  to match proof!  clean up! *) 
             | Certify_Is_Left _ => Certify_Not_Selective _ ((s1, t1), (s2, t2))  
             | Certify_Not_Is_Left _ (t3, t4) => Certify_Not_Selective _ ((s1, t1), (s2, t2))
             end 
           end 
       end 
     | Certify_Is_Left _ => 
       ...
       | Certify_Not_Is_Left _ (t1, t2) =>  
         (* NOT LEFT T *) 
           match crT with 
           | Certify_Is_Right _ => 
             (* RIGHT T *) 
                match crS with 
                | Certify_Is_Right _ =>   (* CAN'T HAPPEN with not-trivial S *) 
                  (* RIGHT S *)  Certify_Selective _ 
                | Certify_Not_Is_Right _ (s1, s2) => 
                  (* NOT RIGHT S *) Certify_Not_Selective _ ((s1, t1), (s2, t2))  
                end 
           | Certify_Not_Is_Right _ (t3, t4) => 
             ...
             | Certify_Is_Right _ => 
               (* RIGHT S *) (* MUST BE NOT LEFT S *) 
                match clS with 
                | Certify_Is_Left _  => (* NOT POSSIBLE *) Certify_Selective _ 
                | Certify_Not_Is_Left _  (s1, s2) => Certify_Not_Selective _ ((s1, t3), (s2, t4))
                end 
             | Certify_Not_Is_Right _ (s1, s2) => 
               (* NOT RIGHT S *)  Certify_Not_Selective _ ((s1, t1), (s2, t2))  
             end 
...
:= λ S T cS cT,  
      match cS, cT with 
      | Certify_Exists_Id _ s, Certify_Exists_Id _ t => Certify_Exists_Id (S * T) (s, t) 
      | Certify_Not_Exists_Id _ , _                 => Certify_Not_Exists_Id (S * T)
      | _, Certify_Not_Exists_Id _                => Certify_Not_Exists_Id (S * T)
      end. 
...
:= λ S T cS cT,  
      match cS, cT with 
      | Certify_Exists_Ann _ s, Certify_Exists_Ann _ t => Certify_Exists_Ann (S * T) (s, t) 
      | Certify_Not_Exists_Ann _, _                  => Certify_Not_Exists_Ann (S * T)
      | _, Certify_Not_Exists_Ann _                  => Certify_Not_Exists_Ann (S * T)
      end. 
...
| Certify_Witness _ s, Certify_Witness _ t => 
   match dS with 
   | Certify_Left_Distributive _ => 
     match dT with 
     | Certify_Left_Distributive _ => Certify_Left_Distributive (S * T) 
     | Certify_Not_Left_Distributive _ (t1, (t2, t3)) => 
          Certify_Not_Left_Distributive (S * T) ((s, t1), ((s, t2), (s, t3))) 
     end 
   | Certify_Not_Left_Distributive _ (s1, (s2, s3)) => 
...
| Certify_Witness _ s, Certify_Witness _ t => 
   match dS with 
   | Certify_Right_Distributive _ => 
     match dT with 
     | Certify_Right_Distributive _ => Certify_Right_Distributive (S * T) 
     | Certify_Not_Right_Distributive _ (t1, (t2, t3)) => 
          Certify_Not_Right_Distributive (S * T) ((s, t1), ((s, t2), (s, t3))) 
     end 
   | Certify_Not_Right_Distributive _ (s1, (s2, s3)) => 
...
:= λ S T dS dT,  
   match dS with 
   | Certify_Plus_Id_Equals_Times_Ann _ => 
     match dT with 
     | Certify_Plus_Id_Equals_Times_Ann _ => Certify_Plus_Id_Equals_Times_Ann (S * T) 
     | Certify_Not_Plus_Id_Equals_Times_Ann _ => 
...
:= λ S T dS dT,  
   match dS with 
   | Certify_Times_Id_Equals_Plus_Ann _ => 
     match dT with 
     | Certify_Times_Id_Equals_Plus_Ann _ => Certify_Times_Id_Equals_Plus_Ann (S * T) 
     | Certify_Not_Times_Id_Equals_Plus_Ann _ => 
...
:= λ S T s t dS dT,  
match dS with 
| Certify_Left_Left_Absorptive _ => 
     match dT with 
     | Certify_Left_Left_Absorptive _ => Certify_Left_Left_Absorptive (S * T) 
     | Certify_Not_Left_Left_Absorptive _ (t1, t2) => 
          Certify_Not_Left_Left_Absorptive (S * T) ((s, t1), (s, t2))
     end 
| Certify_Not_Left_Left_Absorptive _ (s1, s2) => 
...
:= λ S T s t dS dT,  
match dS with 
| Certify_Left_Right_Absorptive _ => 
     match dT with 
     | Certify_Left_Right_Absorptive _ => Certify_Left_Right_Absorptive (S * T) 
     | Certify_Not_Left_Right_Absorptive _ (t1, t2) => 
          Certify_Not_Left_Right_Absorptive (S * T) ((s, t1), (s, t2))
     end 
| Certify_Not_Left_Right_Absorptive _ (s1, s2) => 
...
:= λ S T s t dS dT,  
match dS with 
| Certify_Right_Left_Absorptive _ => 
     match dT with 
     | Certify_Right_Left_Absorptive _ => Certify_Right_Left_Absorptive (S * T) 
     | Certify_Not_Right_Left_Absorptive _ (t1, t2) => 
          Certify_Not_Right_Left_Absorptive (S * T) ((s, t1), (s, t2))
     end 
| Certify_Not_Right_Left_Absorptive _ (s1, s2) => 
...
:= λ S T s t dS dT,  
match dS with 
| Certify_Right_Right_Absorptive _ => 
     match dT with 
     | Certify_Right_Right_Absorptive _ => Certify_Right_Right_Absorptive (S * T) 
     | Certify_Not_Right_Right_Absorptive _ (t1, t2) => 
          Certify_Not_Right_Right_Absorptive (S * T) ((s, t1), (s, t2))
     end 
| Certify_Not_Right_Right_Absorptive _ (s1, s2) => 
...
:= λ S T ntS cT,  
   ...
   | Certify_Witness _ s => 
      match cT with 
      | Certify_Commutative _ => Certify_Commutative (S * T)
      | Certify_Not_Commutative _ (t1, t2) => Certify_Not_Commutative _ ((s, t1), (s, t2))
      end 
   end. 
...
:= λ S T ntS cT,  
   ...
   | Certify_Witness _ s => 
      match cT with 
      | Certify_Idempotent _       => Certify_Idempotent _ 
      | Certify_Not_Idempotent _ t1 => Certify_Not_Idempotent _ (s, t1) 
      end
   end.
...
:= λ S T ntS dT,  
   ...
   | Certify_Witness _ s => 
     match dT with 
     | Certify_Selective _             => Certify_Selective _ 
     | Certify_Not_Selective _ (t1, t2) => Certify_Not_Selective _ ((s, t1), (s, t2)) 
     end
  end. 
...
| Certify_Left_Distributive _ => 
   ...
   | Certify_Left_Distributive _ => 
       match lcS_d with 
       | Certify_Left_Cancellative _ => Certify_Left_Distributive (S * T) 
       | Certify_Not_Left_Cancellative _ (s1, (s2, s3)) => 
            match lkT_d with 
            | Certify_Left_Constant _ => Certify_Left_Distributive (S * T) 
            | Certify_Not_Left_Constant _ (t1, (t2, t3)) => 
...
| Certify_Right_Distributive _ => 
   ...
   | Certify_Right_Distributive _ => 
       match lcS_d with 
       | Certify_Right_Cancellative _ => Certify_Right_Distributive (S * T) 
       | Certify_Not_Right_Cancellative _ (s1, (s2, s3)) => 
            match lkT_d with 
            | Certify_Right_Constant _ => Certify_Right_Distributive (S * T) 
            | Certify_Not_Right_Constant _ (t1, (t2, t3)) => 
...
| Certify_Left_Left_Absorptive _ => 
     ...
     | Certify_Not_Left_Left_Absorptive _ (t1, t2) => 
       match alS with 
       | Certify_Anti_Left _ => Certify_Left_Left_Absorptive (S * T) 
       | Certify_Not_Anti_Left _ (s1, s2) => 
...
| Certify_Left_Right_Absorptive _ => 
     ...
     | Certify_Not_Left_Right_Absorptive _ (t1, t2) => 
       match alS with 
       | Certify_Anti_Right _ => Certify_Left_Right_Absorptive (S * T) 
       | Certify_Not_Anti_Right _ (s1, s2) => 
...
| Certify_Right_Left_Absorptive _ => 
     ...
     | Certify_Not_Right_Left_Absorptive _ (t1, t2) => 
       match alS with 
       | Certify_Anti_Left _ => Certify_Right_Left_Absorptive (S * T) 
       | Certify_Not_Anti_Left _ (s1, s2) => 
...
| Certify_Right_Right_Absorptive _ => 
     ...
     | Certify_Not_Right_Right_Absorptive _ (t1, t2) => 
       match alS with 
       | Certify_Anti_Right _ => Certify_Right_Right_Absorptive (S * T) 
       | Certify_Not_Anti_Right _ (s1, s2) => 
...
:= λ S dS,  
   match dS with 
   | Certify_Left_Distributive _ => Certify_Left_Distributive (with_constant S) 
   | Certify_Not_Left_Distributive _ (s1, (s2, s3)) => 
...
:= λ S dS,  
   match dS with 
   | Certify_Right_Distributive _ => Certify_Right_Distributive (with_constant S) 
   | Certify_Not_Right_Distributive _ (s1, (s2, s3)) => 
...
:= λ S s dS ,  
match dS with 
| Certify_Left_Left_Absorptive _ => Certify_Left_Left_Absorptive (with_constant S)
| Certify_Not_Left_Left_Absorptive _ (s1, s2) => 
...
:= λ S s dS ,  
match dS with 
| Certify_Left_Right_Absorptive _ => Certify_Left_Right_Absorptive (with_constant S)
| Certify_Not_Left_Right_Absorptive _ (s1, s2) => 
...
:= λ S s dS ,  
match dS with 
| Certify_Right_Left_Absorptive _ => Certify_Right_Left_Absorptive (with_constant S)
| Certify_Not_Right_Left_Absorptive _ (s1, s2) => 
...
:= λ S s dS ,  
match dS with 
| Certify_Right_Right_Absorptive _ => Certify_Right_Right_Absorptive (with_constant S)
| Certify_Not_Right_Right_Absorptive _ (s1, s2) => 
...
:= λ S c idemS_d llaS_d rlaS_d ldS_d, 
   ...
   | Certify_Left_Distributive  _ => 
    ...
    | Certify_Left_Left_Absorptive _ => 
      ...
      | Certify_Right_Left_Absorptive _ => 
         match idemS_d with 
         | Certify_Idempotent _      => Certify_Left_Distributive _ 
         | Certify_Not_Idempotent _ s => Certify_Not_Left_Distributive _ (inr s, (inl c, inl c))
        end 
      | Certify_Not_Right_Left_Absorptive _ (s1, s2) => 
...
:= λ S c idemS_d llaS_d rlaS_d ldS_d, 
   ...
   | Certify_Right_Distributive _ => 
    ...
    | Certify_Left_Right_Absorptive _ => 
      ...
      | Certify_Right_Right_Absorptive _ => 
         match idemS_d with 
         | Certify_Idempotent _      => Certify_Right_Distributive _ 
         | Certify_Not_Idempotent _ s => Certify_Not_Right_Distributive _ (inr s, (inl c, inl c))
        end 
      | Certify_Not_Right_Right_Absorptive _ (s1, s2) => 
...
:= λ S c idemS_d laS_d, 
   ...
   | Certify_Left_Left_Absorptive _ => 
     match idemS_d with 
     | Certify_Idempotent _ => Certify_Left_Left_Absorptive _ 
     | Certify_Not_Idempotent _ s =>  Certify_Not_Left_Left_Absorptive _ (inr s, inl c) 
     end 
   | Certify_Not_Left_Left_Absorptive _ (s1, s2) => Certify_Not_Left_Left_Absorptive _ (inr _ s1, inr _ s2)
   end. 
...
:= λ S c idemS_d laS_d, 
   ...
   | Certify_Left_Right_Absorptive _ => 
     match idemS_d with 
     | Certify_Idempotent _ => Certify_Left_Right_Absorptive _ 
     | Certify_Not_Idempotent _ s =>  Certify_Not_Left_Right_Absorptive _ (inr s, inl c) 
     end 
   | Certify_Not_Left_Right_Absorptive _ (s1, s2) => Certify_Not_Left_Right_Absorptive _ (inr _ s1, inr _ s2)
   end. 
...
:= λ S c idemS_d laS_d, 
   ...
   | Certify_Right_Left_Absorptive _ => 
     match idemS_d with 
     | Certify_Idempotent _ => Certify_Right_Left_Absorptive _ 
     | Certify_Not_Idempotent _ s =>  Certify_Not_Right_Left_Absorptive _ (inr s, inl c) 
     end 
   | Certify_Not_Right_Left_Absorptive _ (s1, s2) => Certify_Not_Right_Left_Absorptive _ (inr _ s1, inr _ s2)
   end. 
...
:= λ S c idemS_d laS_d, 
   ...
   | Certify_Right_Right_Absorptive _ => 
     match idemS_d with 
     | Certify_Idempotent _ => Certify_Right_Right_Absorptive _ 
     | Certify_Not_Idempotent _ s =>  Certify_Not_Right_Right_Absorptive _ (inr s, inl c) 
     end 
   | Certify_Not_Right_Right_Absorptive _ (s1, s2) => Certify_Not_Right_Right_Absorptive _ (inr _ s1, inr _ s2)
   end. 
...
:= λ S T cS cT,  
      match cS, cT with 
      | Certify_Commutative _, Certify_Commutative _ => Certify_Commutative _ 
      | Certify_Not_Commutative _ (s1, s2), _  => Certify_Not_Commutative _ ((inl _ s1), (inl _ s2))
      | _, Certify_Not_Commutative _ (t1, t2)  => Certify_Not_Commutative _ ((inr _ t1), (inr _ t2))
      end. 
...
:= λ S T cS cT,  
      match cS, cT with 
      | Certify_Idempotent _, Certify_Idempotent _ => Certify_Idempotent _ 
      | Certify_Not_Idempotent _ s1 , _       => Certify_Not_Idempotent _ (inl _ s1)
      | _, Certify_Not_Idempotent _ t1        => Certify_Not_Idempotent _ (inr _ t1)
      end. 
...
:= λ S T cS cT,  
      match cS, cT with 
      | Certify_Selective _, Certify_Selective _ => Certify_Selective _ 
      | Certify_Not_Selective _ (s1, s2), _    => Certify_Not_Selective _ ((inl _ s1), (inl _ s2))
      | _, Certify_Not_Selective _ (t1, t2)    => Certify_Not_Selective _ ((inr _ t1), (inr _ t2))
      end. 
...
:= λ S T cT,  
      match cT with 
      | Certify_Exists_Id _ t    => Certify_Exists_Id (S + T) (inr S t) 
...
:= λ S T cS,  
      match cS with 
      | Certify_Exists_Id _ s    => Certify_Exists_Id (S + T) (inl T s) 
      | Certify_Not_Exists_Id _ => Certify_Not_Exists_Id (S + T)
      end. 
...
:= λ S T cS,  
      match cS with 
      | Certify_Exists_Ann _ s    => Certify_Exists_Ann (S + T) (inl T s)
...
:= λ S T cT,  
      match cT with 
      | Certify_Exists_Ann _ t    => Certify_Exists_Ann (S + T) (inr S t)
      | Certify_Not_Exists_Ann _ => Certify_Not_Exists_Ann (S + T)
      end. 
