...
; A_bs_plus_id_is_times_ann_d := 
    bops_add_one_id_equals_ann_decide S rS c plusS timesS (A_eqv_reflexive S rS eqvS) (A_eqv_nontrivial S rS eqvS)
...
{| 
   ...
   ; A_bs_plus         := bop_add_ann (A_bs_plus S bsS) c
   ; A_bs_times        := bop_add_id (A_bs_times S bsS) c
