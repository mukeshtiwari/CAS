...
Lemma brel_conjunction_congruence : 
         ∀ (S: Type) (eq : brel S) (r1 : brel S) (r2 : brel S),  
            brel_congruence S eq r1  → 
            brel_congruence S eq r2  → 
               brel_congruence S eq (brel_conjunction S r1 r2). 
...
Lemma brel_conjunction_reflexive : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
              (brel_reflexive S r1) → (brel_reflexive S r2) 
               → brel_reflexive S (brel_conjunction S r1 r2). 
Proof. unfold brel_reflexive, brel_conjunction. 
       intros S r1 r2 ref1 ref2 s. rewrite (ref1 s), (ref2 s). simpl. reflexivity. 
Defined. 

Lemma brel_conjunction_not_reflexive_left : ∀ (S : Type) (r1 : brel S) (r2 : brel S),   
              (brel_not_reflexive S r1) 
               → brel_not_reflexive S (brel_conjunction S r1 r2). 
Proof. unfold brel_not_reflexive, brel_conjunction. 
       intros S r1 r2 [s P]. 
       exists s. rewrite P. reflexivity. 
Defined. 


Lemma brel_conjunction_not_reflexive_right : ∀ (S : Type) (r1 : brel S) (r2 : brel S),   
              (brel_not_reflexive S r2) 
               → brel_not_reflexive S (brel_conjunction S r1 r2). 
Proof. unfold brel_not_reflexive, brel_conjunction. 
       intros S r1 r2 [s P]. 
       exists s. rewrite P. apply andb_comm. 
Defined. 
...
Definition brel_conjunction_reflexive_decide: 
   ∀ (S : Type) 
     ...
     brel_reflexive_decidable S r2 → 
        brel_reflexive_decidable S (brel_conjunction S r1 r2)
:= λ S r1 r2 d1 d2,  
       match d1 with 
       | inl ref1 => 
         match d2 with 
...
Lemma brel_conjunction_irreflexive_left : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
        brel_irreflexive S r1 -> 
           brel_irreflexive S (brel_conjunction S r1 r2). 
Proof. 
     unfold brel_irreflexive, brel_conjunction. 
     intros S r1 r2 irr s. rewrite (irr s). reflexivity. 
Defined. 


Lemma brel_conjunction_irreflexive_right : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
        brel_irreflexive S r2 -> 
           brel_irreflexive S (brel_conjunction S r1 r2). 
Proof. 
     unfold brel_irreflexive, brel_conjunction. 
     intros S r1 r2 irr s. rewrite (irr s). apply andb_comm. 
Defined. 

Lemma brel_conjunction_irreflexive : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
        ((brel_irreflexive S r1) + (brel_irreflexive S r2)) -> 
           brel_irreflexive S (brel_conjunction S r1 r2). 
Proof. intros S r1 r2 [L | R]. 
       apply brel_conjunction_irreflexive_left; auto. 
       apply brel_conjunction_irreflexive_right; auto. 
Defined. 

Lemma brel_conjunction_symmetric : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
              (brel_symmetric S r1) → (brel_symmetric S r2) 
               → brel_symmetric S (brel_conjunction S r1 r2). 
Proof. unfold brel_symmetric, brel_conjunction. 
     intros S r1 r2 sym1 sym2 s1 s2 H.  
...
Lemma brel_conjunction_asymmetric_left : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
              (brel_asymmetric S r1) → 
                  brel_asymmetric S (brel_conjunction S r1 r2). 
...
Lemma brel_conjunction_transitive : ∀ (S : Type) (r1 : brel S) (r2 : brel S),  
        brel_transitive S r1 -> 
        brel_transitive S r2 -> 
            brel_transitive S (brel_conjunction S r1 r2). 
Proof. unfold brel_transitive, brel_conjunction.  
     intros S r1 r2 trans1 trans2 s1 s2 s3 H1 H2. 
...
Lemma brel_conjunction_antisymmetric : 
         ∀ (S : Type) (eq : brel S) (r1 : brel S) (r2 : brel S),  
              ...
              brel_antisymmetric S eq (brel_conjunction S r1 r2). 
