...
Lemma brel_strictify_irreflexive_v1 : ∀ (S : Type) (r : brel S), 
          brel_reflexive S r -> brel_irreflexive S (brel_strictify r).  
Proof. intros S r H. 
...
Lemma brel_strictify_irreflexive_v2 : ∀ (S : Type) (r : brel S), 
          brel_irreflexive S r -> brel_irreflexive S (brel_strictify r).  
Proof. intros S r H. 
       unfold brel_strictify. 
       apply brel_conjunction_irreflexive. 
       left. 
...
Lemma brel_strictify_irreflexive : ∀ (S : Type) (r : brel S), 
       ((brel_reflexive S r) + (brel_irreflexive S r)) -> brel_irreflexive S (brel_strictify r).  
...
Lemma brel_strictify_congruence : ∀ (S : Type) (r1 : brel S) (r2 : brel S), 
         brel_congruence S r1 r2 -> brel_congruence S r1 (brel_strictify r2). 
