...
Lemma brel_dual_antisymmetric : ∀ (S : Type) (eqS rS : brel S),  
      brel_antisymmetric _ eqS rS → brel_antisymmetric S eqS (brel_dual rS). 
...
Lemma brel_dual_exists_bottom : ∀ (S : Type) (rS : brel S),  
             brel_exists_top S rS -> brel_exists_bottom S (brel_dual rS). 
Proof.  intros S rS [t P]. exists t. intro s. apply P. Defined. 

Lemma brel_dual_not_exists_bottom : ∀ (S : Type) (rS : brel S), 
             brel_not_exists_top S rS -> brel_not_exists_bottom S (brel_dual rS). 
Proof.  intros S rS P s. exists (projT1 (P s)). destruct (P s) as [w F]. compute; auto. Defined. 
...
Definition brel_dual_exists_top_decide : 
   ∀ (S : Type) 
     ...
     brel_exists_bottom_decidable S r -> 
         brel_exists_top_decidable S (brel_dual r)
:= λ S r d, 
   match d with 
...
Definition brel_dual_total_decide : 
   ∀ (S : Type) 
     ...
     brel_total_decidable S r -> 
         brel_total_decidable S (brel_dual r)
:= λ S r d, 
   match d with 
...
Definition brel_dual_exists_bottom_decide : 
   ∀ (S : Type) 
     ...
     brel_exists_top_decidable S r -> 
         brel_exists_bottom_decidable S (brel_dual r)
:= λ S r d, 
   match d with 
