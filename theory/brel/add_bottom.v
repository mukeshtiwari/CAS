...
Notation "c == r"  := (brel_add_constant r c) (at level 15).
Notation "c <<= r"  := (brel_add_bottom r c)   (at level 15).

Lemma brel_add_bottom_congruence : brel_congruence (with_constant S) (c == rS) (c <<= rS). 
Proof. intros [s | s] [t | t] [u | u] [v | v]; simpl; intros H Q.
       reflexivity.
       reflexivity.
       discriminate.
       discriminate.
...
Lemma brel_add_bottom_reflexive : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
          brel_reflexive S rS → brel_reflexive (with_constant S) (brel_add_bottom rS c). 
...
Lemma brel_add_bottom_transitive : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
    (brel_transitive _ rS) → brel_transitive (with_constant S) (brel_add_bottom rS c). 
...
Lemma brel_add_bottom_antisymmetric : ∀ (S : Type) (eqS rS : brel S) (c : cas_constant),  
      (brel_antisymmetric _ eqS rS) → 
         brel_antisymmetric (with_constant S) (brel_add_constant eqS c)(brel_add_bottom rS c). 
...
Lemma brel_add_bottom_not_antisymmetric : ∀ (S : Type) (eqS rS : brel S) (c : cas_constant),  
      (brel_not_antisymmetric _ eqS rS) → 
         brel_not_antisymmetric (with_constant S) (brel_add_constant eqS c)(brel_add_bottom rS c). 
...
Lemma brel_add_bottom_total : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
      (brel_total _ rS) → brel_total (with_constant S) (brel_add_bottom rS c). 
Proof.  intros S rS c symS [c1 | s1] [c2 | s2]; simpl; auto.  Qed. 

Lemma brel_add_bottom_not_total : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
      (brel_not_total _ rS) → brel_not_total (with_constant S) (brel_add_bottom rS c). 
...
Lemma brel_add_bottom_exists_bottom : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
             brel_exists_bottom (with_constant S) (brel_add_bottom rS c). 
...
Lemma brel_add_bottom_exists_top : ∀ (S : Type) (rS : brel S) (c : cas_constant),  
             ...
             brel_exists_top (with_constant S) (brel_add_bottom rS c). 
...
Lemma brel_add_bottom_not_exists_top : ∀ (S : Type) (rS : brel S) (c : cas_constant) (w : S),  
             ...
             brel_not_exists_top (with_constant S) (brel_add_bottom rS c). 
