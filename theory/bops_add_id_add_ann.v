...
Lemma bops_add_id_add_ann_left_absorption  : 
   ∀ (S : Type) (r : brel S) (c : cas_constant) (b1 b2 : binary_op S),
     brel_reflexive S r -> 
...
Lemma bops_add_id_add_ann_not_left_absorption  : 
   ∀ (S : Type) (r : brel S) (c : cas_constant) (b1 b2 : binary_op S),
...
Lemma bops_add_id_add_ann_right_absorption  : 
   ∀ (S : Type) (r : brel S) (c : cas_constant) (b1 b2 : binary_op S),
     brel_reflexive S r -> 
...
Lemma bops_add_id_add_ann_not_right_absorption  : 
   ∀ (S : Type) (r : brel S) (c : cas_constant) (b1 b2 : binary_op S),
