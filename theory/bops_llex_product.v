...
Lemma bops_llex_product_left_absorption : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) (addS  mulS : binary_op S) (addT mulT : binary_op T), 
      brel_reflexive T rT → 
      bops_left_absorption S rS addS mulS → 
      ((bops_left_absorption T rT addT mulT) + (bop_anti_left S rS mulS)) → 
         bops_left_absorption (S * T) 
             (brel_product _ _ rS rT) 
             (bop_llex _ _ rS addS addT)
             (bop_product _ _ mulS mulT). 
Proof. intros S T rS rT addS mulS addT mulT refT ldS [ldT| F] [s1 t1] [s2 t2].
       simpl. 
       unfold bops_left_absorption in ldS. 
       unfold bops_left_absorption in ldT. 
       rewrite ldS. simpl. 
...
Lemma bops_llex_product_not_left_absorption_left : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
     (addS  mulS : binary_op S) (addT mulT : binary_op T) (t :T), 
      bops_not_left_absorption S rS addS mulS → 
         bops_not_left_absorption (S * T) 
             (brel_product _ _ rS rT) 
             (bop_llex _ _ rS addS addT)
             (bop_product _ _ mulS mulT). 
...
Lemma bops_llex_product_not_left_absorption_right : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
...
Lemma bops_llex_product_right_absorption : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) (addS  mulS : binary_op S) (addT mulT : binary_op T), 
      brel_reflexive T rT → 
      bops_right_absorption S rS addS mulS → 
      ((bops_right_absorption T rT addT mulT) + (bop_anti_right S rS mulS)) → 
         bops_right_absorption (S * T) 
             (brel_product _ _ rS rT) 
             (bop_llex _ _ rS addS addT)
             (bop_product _ _ mulS mulT). 
Proof. intros S T rS rT addS mulS addT mulT refT ldS [ldT| F] [s1 t1] [s2 t2].
       simpl. 
       unfold bops_right_absorption in ldS. 
       unfold bops_right_absorption in ldT.
       compute.  
       rewrite ldS. 
...
Lemma bops_llex_product_not_right_absorption_left : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
     (addS  mulS : binary_op S) (addT mulT : binary_op T) (t :T), 
      bops_not_right_absorption S rS addS mulS → 
         bops_not_right_absorption (S * T) 
             (brel_product _ _ rS rT) 
             (bop_llex _ _ rS addS addT)
             (bop_product _ _ mulS mulT). 
Proof. intros S T rS rT addS mulS addT mulT t [ [s1 s2] P ]. 
...
Lemma bops_llex_product_not_right_absorption_right : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
     (addS  mulS : binary_op S) (addT mulT : binary_op T), 
