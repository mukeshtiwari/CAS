...
Proof. intros S r [s _]. unfold bop_not_idempotent. exists (s :: nil). simpl. 
       rewrite andb_comm. simpl. reflexivity. 
Defined. 

Lemma bop_concat_not_commutative : 
   ∀ (S : Type) (r : brel S), (brel_nontrivial S r) -> bop_not_commutative (list S) (brel_list S r) (bop_concat S).
Proof. intros S r ntS. 
       destruct (brel_nontrivial_witness S r ntS) as [s sP].
       destruct (brel_nontrivial_negate S r ntS) as [f fP].
...
Lemma bop_concat_not_selective : 
   ∀ (S : Type) (r : brel S), brel_nontrivial S r -> bop_not_selective (list S) (brel_list S r) (bop_concat S).
Proof. intros S r ntS. 
       destruct (brel_nontrivial_witness S r ntS) as [s sP].
       destruct (brel_nontrivial_negate S r ntS) as [f fP].
...
Lemma bop_concat_not_is_left : 
   ∀ (S : Type) (r : brel S), (brel_witness S r) -> bop_not_is_left (list S) (brel_list S r) (bop_concat S).
Proof. intros S r [s P]. unfold bop_concat, bop_not_is_left. 
...
Lemma bop_concat_not_is_right : 
   ∀ (S : Type) (r : brel S), (brel_witness S r) -> bop_not_is_right (list S) (brel_list S r) (bop_concat S).
Proof. intros S r [s P]. unfold bop_concat, bop_not_is_right. 
...
Proof. intros S r [s Ps]. exists (nil, (nil, s :: nil)); simpl. reflexivity. Defined. 

Lemma  bop_concat_not_right_constant : ∀ (S : Type) (r : brel S), 
        brel_witness S r -> 
         bop_not_right_constant (list S) (brel_list S r) (bop_concat S).
Proof. intros S r [s Ps]. exists (nil, (nil, s :: nil)); simpl. reflexivity. Defined. 


Lemma  bop_concat_not_anti_left : ∀ (S : Type) (r : brel S), 
        brel_witness S r -> 
         bop_not_anti_left (list S) (brel_list S r) (bop_concat S).
Proof. intros S r [s Ps]. exists (s :: nil, nil); simpl. 
       rewrite Ps. simpl. reflexivity. 
Defined. 


Lemma  bop_concat_not_anti_right : ∀ (S : Type) (r : brel S), 
        brel_witness S r -> 
         bop_not_anti_right (list S) (brel_list S r) (bop_concat S).
Proof. intros S r [s Ps]. exists (s :: nil, nil); simpl. 
       rewrite Ps. simpl. reflexivity. 
Defined. 
