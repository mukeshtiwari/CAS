...
Lemma bops_or_and_right_absorptive  : 
     bops_right_absorption bool brel_eq_bool bop_or bop_and.
Proof. intros x y. destruct x; destruct y; compute; reflexivity. Qed. 

Lemma bops_or_and_left_absorptive  : 
     bops_left_absorption bool brel_eq_bool bop_or bop_and.
Proof. intros x y. destruct x; destruct y; compute; reflexivity. Qed. 
