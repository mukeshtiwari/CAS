...
Lemma bop_product_left_absorption : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) (addS  mulS : binary_op S) (addT mulT : binary_op T), 
...
Lemma bop_product_not_left_absorption_left : 
...
Lemma bop_product_not_left_absorption_right : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
...
Lemma bop_product_right_absorption : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) (addS  mulS : binary_op S) (addT mulT : binary_op T), 
...
Lemma bop_product_not_right_absorption_left : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
     (addS  mulS : binary_op S) (addT mulT : binary_op T) (t :T), 
...
Lemma bop_product_not_right_absorption_right : 
   ∀ (S T : Type) (rS : brel S) (rT : brel T) 
     (addS  mulS : binary_op S) (addT mulT : binary_op T) (s : S), 
