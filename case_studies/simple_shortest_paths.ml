...
let sq_mat = square_matrix_from_adj_list 3 [(1, [(2, Inr 10); (0, Inr 20)])] simple_shortest_paths
...
[(0, 0,
 ...
 (0, 1, Inr 0); (0, 2, Inr 0); (1, 0, Inr 20);
 (1, 1,
  Inl
   {constant_ascii = ['I'; 'N'; 'F'];
    constant_latex = ['\\'; 'i'; 'n'; 'f'; 't'; 'y']});
 (1, 2, Inr 10); (2, 0, Inr 0); (2, 1, Inr 0);
 (2, 2,
  Inl
   {constant_ascii = ['I'; 'N'; 'F'];
    constant_latex = ['\\'; 'i'; 'n'; 'f'; 't'; 'y']})
...
let _ = match matrix_solver Matrix_power simple_shortest_paths with
  | Inl mf -> List.map (fun (x, y) -> (x, y, (mf sq_mat).mat x y)) (compute_pair [0; 1; 2]) (* how to print this? *)
  | Inr x -> raise (Msg "You algebra does not match with your algorithm")

(* 
[(0, 0, Inr 0); (0, 1, Inr 0); (0, 2, Inr 10); (1, 0, Inr 10);
 (1, 1, Inr 10); (1, 2, Inr 20); (2, 0, Inr 20); (2, 1, Inr 0);
 (2, 2, Inr 0)]
*)