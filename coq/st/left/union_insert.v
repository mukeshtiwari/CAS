...
Lemma slt_union_insert_exists_id_ann_decide (fin_d : carrier_is_finite_decidable S eq) : 
     stl_exists_id_ann_decidable S (finite_set S) (brel_set eq) (bop_union eq) (ltr_insert eq).
Proof. destruct fin_d as [finP | nfinP].
       + assert (A : stl_exists_id_ann_not_equal S (finite_set S) (brel_set eq) (bop_union eq) (ltr_insert eq)).
         ...
         exact (STL_Id_Ann_Proof_Not_Equal _ _ _ _ _ A). 
       + exact (STL_Id_Ann_Proof_Id_None _ _ _ _ _ 
