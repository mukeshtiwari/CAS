...
Section ACAS.
  ...
  Definition cast_A_left_pre_semiring_to_A_slt 
    ...
    {|
      ...
      ; A_slt_proofs := cast_left_semiring_proofs_to_slt_proofs 
        (A_eqv_eq S (A_left_pre_semiring_carrier A))
        (A_left_pre_semiring_plus A)
  ...
  Definition cast_A_selective_left_dioid_to_A_slt_zero_is_ltr_ann 
    ...
    {|
      ...
      ; A_slt_zero_is_ltr_ann_plus_proofs  := A_sg_CS_proofs_to_sg_proofs 
      ...
      ; A_slt_zero_is_ltr_ann_proofs :=  cast_left_dioid_proofs_to_slt_proofs 
        (A_eqv_eq S (A_selective_left_dioid_carrier A))
        (A_selective_left_dioid_plus A)
  ...
  Definition cast_A_left_dioid_to_A_slt_zero_is_ltr_ann   
    ...
    {|
      ...
      ; A_slt_zero_is_ltr_ann_plus_proofs  := A_sg_CI_proofs_to_sg_proofs 
        (A_eqv_eq S (A_left_dioid_carrier A))
        (A_left_dioid_plus A) 
  ...
  {|
    ...
    ; A_slt_zero_is_ltr_ann_proofs :=  cast_left_semiring_proofs_to_slt_proofs 
  ...
  Definition cast_A_slt_CS_to_A_slt 
    ...
    {|
        ...
        ; A_slt_plus_proofs := A_sg_CS_proofs_to_sg_proofs 
  ...
  Definition cast_A_slt_CI_to_A_slt 
    ...
    {|
        ...
        ; A_slt_plus_proofs := A_sg_CI_proofs_to_sg_proofs 
...
Section AMCAS.
  ...
  *)
  Definition cast_A_slt_mcas_to_A_slt_CS {L S : Type}
  ...
  Definition cast_A_slt_mcas_to_A_slt_zero_is_ltr_ann
    {L S : Type} (A : @A_slt_mcas L S) : @A_slt_mcas L S :=
    match A with
    | A_SLT_Error ls => A_SLT_Error ls 
    | A_SLT slt => 
...
Section CAS. 
  ...
  Definition cast_left_pre_semiring_to_slt 
    ...
    {|
      ...
      ; slt_certs := cast_left_semiring_certificates_to_slt_certificates
  ...
  Definition cast_selective_left_dioid_to_slt_zero_is_ltr_ann 
    ...
    {|
      ...
      ; slt_zero_is_ltr_ann_plus_certs  := sg_CS_certs_to_sg_certs
      ...
      ; slt_zero_is_ltr_ann_certs :=  cast_left_dioid_certificates_to_slt_certificates 
  ...
  Definition cast_left_dioid_to_slt_zero_is_ltr_ann   
    ...
    {|
      ...
      ; slt_zero_is_ltr_ann_plus_certs  := sg_CI_certs_to_sg_certs 
  ...
  Definition cast_left_semiring_to_slt_zero_is_ltr_ann   
    ...
    {|
      ...
      ; slt_zero_is_ltr_ann_plus_certs  := sg_C_certs_to_sg_certs
      ...
      ; slt_zero_is_ltr_ann_certs :=  cast_left_semiring_certificates_to_slt_certificates
  ...
  Definition cast_slt_CS_to_slt 
    ...
    {|
        ...
        ; slt_plus_certs := sg_CS_certs_to_sg_certs 
  ...
  Definition cast_slt_CI_to_slt 
    ...
    {|
        ...
        ; slt_plus_certs := sg_CI_certs_to_sg_certs 
...
Section MCAS.
  ...
  Definition cast_slt_mcas_to_slt_CS {L S : Type}
  ...
  Definition cast_slt_mcas_to_slt_zero_is_ltr_ann
    {L S : Type} (A : @slt_mcas L S) : @slt_mcas L S :=
    match A with
    | SLT_Error ls => SLT_Error ls 
    | SLT slt => 
