...
Lemma bops_product_left_strictly_absorptive :
  (bops_left_strictly_absorptive S rS addS mulS *
  bops_left_strictly_absorptive T rT addT mulT) + 
  ((bops_left_strictly_absorptive S rS addS mulS *
  bops_left_left_absorptive T rT addT mulT) +
...
Proof.
  intros [Ha | [Ha | Ha]].
  + apply bops_product_left_strictly_absorptive_v1;
    exact Ha.
  + apply bops_product_left_strictly_absorptive_v2;
    exact Ha.
  + apply bops_product_left_strictly_absorptive_v3; 
    exact Ha.
Defined.
...
Lemma bops_product_right_strictly_absorptive_v2 :
  bops_right_strictly_absorptive S rS addS mulS *
  bops_left_right_absorptive T rT addT mulT ->
  bops_right_strictly_absorptive (S * T) 
  (rS <*> rT) (addS [*] addT) (mulS [*] mulT).
...
Lemma bops_product_right_strictly_absorptive_v3 :
  bops_left_right_absorptive S rS addS mulS *
  bops_right_strictly_absorptive T rT addT mulT ->
  bops_right_strictly_absorptive (S * T) 
  (rS <*> rT) (addS [*] addT) (mulS [*] mulT).
Proof.
  ...
  compute; split.
  + rewrite Ha. apply Hb.
  + destruct (rS (sb *S sa) (sa +S (sb *S sa))); 
    [apply Hb | reflexivity].
Defined.

Lemma bops_product_right_strictly_absorptive :
  (bops_right_strictly_absorptive S rS addS mulS *
  bops_right_strictly_absorptive T rT addT mulT) + 
  ((bops_right_strictly_absorptive S rS addS mulS *
  bops_left_right_absorptive T rT addT mulT) +
...
Proof.
  intros [Ha | [Ha | Ha]].
  + apply bops_product_right_strictly_absorptive_v1;
    exact Ha.
  + apply bops_product_right_strictly_absorptive_v2;
    exact Ha.
  + apply bops_product_right_strictly_absorptive_v3; 
    exact Ha.
Defined.


Lemma bops_product_not_right_strictly_absorptive :
  ...
  (bops_not_right_strictly_absorptive S rS addS mulS + 
  bops_not_left_right_absorptive T rT addT mulT) ->
  bops_not_right_strictly_absorptive (S * T) 
  (rS <*> rT) (addS [*] addT) (mulS [*] mulT).
Proof.
  intros [((s1, s2) & [Ha | Ha]) | ((t1, t2) & [Hb | Hb])]
  [((s3, s4) & Hc) | ((t3, t4) & [Hc | Hc])]
