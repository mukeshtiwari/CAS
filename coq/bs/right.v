...
; A_dioid_times_proofs := sg_proofs_right S eq s f nt eqvP 
...
; A_selective_dioid_times_proofs := sg_proofs_right S eq s f nt eqvP 
...
; dioid_times_certs  := sg_certs_right s f 
...
; selective_dioid_times_certs  := sg_certs_right s f 
...
Proof. destruct sgP. unfold semiring_proofs_sg_right, semiring_certs_sg_right, P2C_semiring; simpl.
Admitted. 
