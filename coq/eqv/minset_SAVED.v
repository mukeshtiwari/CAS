...
Proof. intros H1 H2.
       ...
       apply not_in_set_uop_filter_elim in H2. 
          destruct H2 as [H2 | H2]; auto.
             unfold is_minimal_wrt in H2. 
             apply bProp_forall_false_elim in H2.
             destruct H2 as [s [H2 H3]].
             exists s.
             unfold not_below in H3.
             apply orb_is_false_left in H3. 
             destruct H3 as [H3 H4].
             compute in H3.
             assert (A : in_set rS (uop_minset rS lteS X) s = true).
                apply in_set_minset_intro; auto. split; auto. 
                intros b H5. 
                case_eq(rS s b); intro H6;
                case_eq(lteS b s); intro H7; auto. 
                   case_eq(lteS s a); intro H8.
                      admit.                       
                      rewrite H8 in H3. discriminate H3. 
             assert (B := A). 
             apply in_set_minset_elim in B.
             destruct B as [_ B].
             assert (C := B a H1).
             split; auto. split; auto.

                case_eq(lteS s a); intro D; auto. 
                rewrite D in H3.
                discriminate H3. 
