...
:= λ S eqS bS sgS,
    ...
    | inl cS => Some {|
                   ...
                   ; A_sg_C_exists_id_d      := A_sg_exists_id_d S eqS bS sgS 
                   ; A_sg_C_exists_ann_d     := A_sg_exists_ann_d S eqS bS sgS 
                   ; A_sg_C_left_cancel_d    := A_sg_left_cancel_d S eqS bS sgS 
                   ; A_sg_C_right_cancel_d   := A_sg_right_cancel_d S eqS bS sgS 
                   ; A_sg_C_left_constant_d  := A_sg_left_constant_d S eqS bS sgS 
                   ; A_sg_C_right_constant_d := A_sg_right_constant_d S eqS bS sgS 
...
:= λ S eqS bS sgS,
    ...
    | inl sS => Some {|
                   ...
                   ; A_sg_CS_exists_id_d      := A_sg_C_exists_id_d S eqS bS sgS 
                   ; A_sg_CS_exists_ann_d     := A_sg_C_exists_ann_d S eqS bS sgS 
                 |}
    end.
...
:= λ S eqS bS sgS,
    ...
    | inl sS => Some {|
                   ...
                   ; A_sg_CS_selective        := sS 
                   ; A_sg_CS_exists_id_d      := A_sg_CI_exists_id_d S eqS bS sgS 
                   ; A_sg_CS_exists_ann_d     := A_sg_CI_exists_ann_d S eqS bS sgS 
                 |}
    end.   
...
:= λ S eqS bS sgS,
    ...
    | inl iS => Some {|
                   ...
                   ; A_sg_CI_exists_id_d      := A_sg_C_exists_id_d S eqS bS sgS 
                   ; A_sg_CI_exists_ann_d     := A_sg_C_exists_ann_d S eqS bS sgS 
                 |}
    end.   
...
:= λ S eqS bS sgS,
    match  A_sg_C_left_cancel_d S eqS bS sgS with
    | inr _ => None 
    | inl cS => Some {|
                   ...
                   ; A_sg_CK_left_cancel      := cS
                   ; A_sg_CK_exists_id_d      := A_sg_C_exists_id_d S eqS bS sgS
...
:= λ S sgS,
    ...
    | Certify_Selective => Some {|
                   ...
                   ; sg_CS_exists_id_d      := sg_C_exists_id_d sgS 
                   ; sg_CS_exists_ann_d     := sg_C_exists_ann_d sgS 
                 |}
    end.   
...
:= λ S sgS,
    ...
    | Certify_Selective => Some {|
                   ...
                   ; sg_CS_commutative      := Assert_Commutative 
                   ; sg_CS_selective        := Assert_Selective
                   ; sg_CS_exists_id_d      := sg_CI_exists_id_d sgS 
                   ; sg_CS_exists_ann_d     := sg_CI_exists_ann_d sgS 
                 |}
    end.   
...
:= λ S sgS,
    ...
    | Certify_Idempotent => Some {|
                   ...
                   ; sg_CI_exists_id_d      := sg_C_exists_id_d sgS 
                   ; sg_CI_exists_ann_d     := sg_C_exists_ann_d sgS 
                 |}
    end.   
