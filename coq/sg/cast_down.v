...
:= λ S eqS bS sgS,
    ...
    | inl sS => Some {|
                   ...
                   ; A_sg_CS_exists_id_d      := A_asg_exists_id_d S eqS bS sgS 
                   ; A_sg_CS_exists_ann_d     := A_asg_exists_ann_d S eqS bS sgS 
                 |}
    end.
...
:= λ S sgS,
    ...
    | Certify_Selective => Some {|
                   ...
                   ; sg_CS_exists_id_d      := asg_exists_id_d sgS 
                   ; sg_CS_exists_ann_d     := asg_exists_ann_d sgS 
                 |}
    end.
