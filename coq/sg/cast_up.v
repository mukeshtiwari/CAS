...
; A_asg_exists_id_d      := A_sg_C_exists_id_d S r b sgS    
; A_asg_exists_ann_d     := A_sg_C_exists_ann_d S r b sgS    
|}. 
...
; A_msg_exists_id_d      := A_sg_exists_id_d S r b sgS
; A_msg_exists_ann_d     := A_sg_exists_ann_d S r b sgS
...
; asg_exists_id_d      := sg_C_exists_id_d sgS    
; asg_exists_ann_d     := sg_C_exists_ann_d sgS    
|}. 
...
Definition sg_C_certs_from_sg_CK_certs : ∀ {S : Type}, brel S -> binary_op S -> S -> (S -> S) -> @sg_CK_certificates S -> @sg_C_certificates S
:= λ {S} r b s f sgS, 
