...
Definition ltr_congruence (L S : Type) (eqL : brel L) (eqS : brel S) (ltr : left_transform L S) := 
...
Definition p2c_ltr_congruence (L S : Type) (eqL : brel L) (eqS : brel S) (ltr : left_transform L S) 
    (p : ltr_congruence  L S eqL eqS ltr) : @assert_ltr_congruence L S := Assert_Ltr_Congruence. 
  
Definition p2c_ltr_is_right : ∀ (L S : Type) (lte : brel S) (ltr : left_transform L S), 
...
Definition p2c_ltr_left_cancellative : ∀ (L S : Type) (lte : brel S) (ltr : left_transform L S), 
...
Definition p2c_ltr_exists_id : ∀ (L S : Type) (eq : brel S) (ltr : left_transform L S), 
       ltr_exists_id_decidable L S eq ltr -> @check_ltr_exists_id L S 
:= λ S eq b1 b2 d, 
   match d with 
